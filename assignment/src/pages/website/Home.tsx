  ...
  return (
    <div className='container-fuild'>
      ...
      <div className="container" style={{ paddingTop: '30px', paddingBottom: "20px" }}>
        <Card.Title className="text text-center" style={{ marginBottom: "30px" }}><h1>Sản phẩm mới</h1></Card.Title>
        <div style={{ display: "flex" }}>
          {products.products?.map((a) => {
            return (
              <Card className="col-md-6 col-lg-3 border border-white" style={{ marginRight: "20px" }}>
                <Link to={`/product/${a._id}`}>
                  <Card.Body>
                    <Card.Img src={a.image} style={{ width: '100%' }} />
                    <Card.Title className="text py-3 pb-4 px-3 text-center" style={{ textDecoration: "0" }} >{a.name}</Card.Title>
                    <Card.Subtitle className="mb-2 text-muted text-center">{a.price}.000 VND/Kg</Card.Subtitle>
