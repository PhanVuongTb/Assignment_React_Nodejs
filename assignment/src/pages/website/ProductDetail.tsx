                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                  ...
                  <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div className="flex" style={{ paddingTop: "20px" }}>
                      <span className="title-font font-medium text-2xl text-gray-900">{product?.price}.000 VNĐ</span>
                      ...
                      <button onClick={() => { addItemToCart() }} className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">ORDER</button>
